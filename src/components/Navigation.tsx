    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-8">
          ...
          <a
            href="#contact"
            className="ml-2 px-5 py-2 bg-gold text-navy text-sm font-semibold rounded-lg hover:brightness-110 transition"
          >
            Request a Demo
          </a>
        </div>
        ...
        >
          <span className={isNavDark ? "text-white" : "text-navy"}>
            {mobileOpen ? "✕" : "☰"}
          </span>
        </button>
      </div>
            ...
            {navLinks.map((link) => (
              <a
                ...
                className={`text-sm font-medium ${
                  isNavDark ? "text-white/80 hover:text-white" : "text-navy/80 hover:text-navy"
                }`}
              >
                {link.label}
              </a>
